...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal sealed class PEAttributeData : CSharpAttributeData
    {
        ...
        private readonly CustomAttributeData _handle;
        ...
        internal PEAttributeData(PEModuleSymbol moduleSymbol, CustomAttributeData handle)
        {
...
#pragma warning restore 0252
        ...
        internal override bool IsTargetAttribute(string namespaceName, string typeName)
        {
         ...
         var t1=   _handle.Constructor.DeclaringType;

            var ns = t1.Namespace;
            var ts = t1.Name;


            return (ns == namespaceName) && (ts == typeName);//_decoder.IsTargetAttribute(_handle, namespaceName, typeName);
        }
