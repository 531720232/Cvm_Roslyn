    ...
    internal class PEParameterSymbol : ParameterSymbol
    {
       ...
       //     _packedFlags = new PackedFlags(refKind, attributesAreComplete: handle.IsNil, hasNameInMetadata: hasNameInMetadata);
        ...
        internal ConstantValue ImportConstantValue(bool ignoreAttributes = false)
        {
            ...
            {
                value = _moduleSymbol.Module.GetConstantValue(_handle.DefaultValue);
            }
        ...
        internal override bool IsIDispatchConstant
        {
            get
            {
                ...
                return _handle.IsDefined(typeof(System.Runtime.CompilerServices.IDispatchConstantAttribute), false); 
            }
        }
        ...
        internal override bool IsIUnknownConstant
        {
            get
            {
                ...
                return _handle.IsDefined(typeof(System.Runtime.CompilerServices.IUnknownConstantAttribute), false); ;
            }
        }
        ...
        internal override FlowAnalysisAnnotations FlowAnalysisAnnotations
        {
            get
            {
                    ...
                    !_packedFlags.TryGetWellKnownAttribute(assertsFalse, out bool hasAssertsFalse))
                {
                    ...
                    _packedFlags.SetWellKnownAttribute(notNullWhenFalse, false);
                    _packedFlags.SetWellKnownAttribute(assertsTrue, false);
                    _packedFlags.SetWellKnownAttribute(assertsFalse, false);
                ...
                return FlowAnalysisAnnotationsFacts.Create(
                    notNullWhenTrue: hasNotNullWhenTrue, notNullWhenFalse: false,
                    assertsTrue: false, assertsFalse: false);
            }
        }
        ...
        internal override ImmutableArray<byte> MarshallingDescriptor
        {
            get
            {
                ...
                Debug.Assert(_handle != null);
                return default(ImmutableArray<byte>);// _moduleSymbol.Module.GetMarshallingDescriptor(_handle);
            }
        }
        ...
        internal override UnmanagedType MarshallingType
        {
            get
            {
                ...
                Debug.Assert(_handle != null);
                return UnmanagedType.AsAny;// _moduleSymbol.Module.GetMarshallingType(_handle);
            }
        }
        ...
        public override bool IsParams
        {
            get
            {
                ...
                if (!_lazyIsParams.HasValue())
                {
                    ...
                    _lazyIsParams =(_handle).IsDefined(typeof(System.ParamArrayAttribute),false).ToThreeState();
                }
        ...
        public override ImmutableArray<CSharpAttributeData> GetAttributes()
        {
            if (_lazyCustomAttributes.IsDefault)
            {
                ...
                {
                    CustomAttributeData paramArrayAttribute;
                    CustomAttributeData constantAttribute;
                    CustomAttributeData isReadOnlyAttribute;
                    ...
                    if (paramArrayAttribute!=null || constantAttribute!=null)
                    {
                        ...
                        {
                            var gc = new PEAttributeData(containingPEModuleSymbol, paramArrayAttribute);
                            var dc = gc.AttributeConstructor;
