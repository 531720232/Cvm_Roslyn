...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal struct TupleTypeDecoder
    {
        ...
        public static TypeSymbol DecodeTupleTypesIfApplicable(
            ...
            System.Reflection.ICustomAttributeProvider targetHandle,
            PEModuleSymbol containingModule)
        {
            ImmutableArray<string> elementNames=ImmutableArray<string>.Empty;
            var hasTupleElementNamesAttribute = targetHandle.IsDefined(typeof(System.Runtime.CompilerServices.TupleElementNamesAttribute), false);

            if(hasTupleElementNamesAttribute)
            {
                foreach(System.Runtime.CompilerServices.TupleElementNamesAttribute v in targetHandle.GetCustomAttributes(typeof(System.Runtime.CompilerServices.TupleElementNamesAttribute),false))
                {
                    elementNames= elementNames.AddRange(v.TransformNames);
                }
            }
