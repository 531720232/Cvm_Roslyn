...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal sealed class PEEventSymbol : EventSymbol
    {
        ...
        private readonly EventInfo _handle;
            ...
            MultiDictionary<string, PEFieldSymbol> privateFieldNameToSymbols)
        {
            ...
            var eventType = handle.EventHandlerType;

            try
            {
                ef = handle.Attributes;
                _name = handle.Name;
            }
            ...
            //    var typeSymbol = DynamicTypeDecoder.TransformType(originalEventType, targetSymbolCustomModifierCount, eventType, moduleSymbol);
            ...
            //    type = NullableTypeDecoder.TransformType(type, eventType, moduleSymbol);
