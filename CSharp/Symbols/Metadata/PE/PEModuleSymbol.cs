...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal sealed class PEModuleSymbol : NonMissingModuleSymbol
    {
        ...
        internal readonly ConcurrentDictionary<Type, TypeSymbol> TypeHandleToTypeMap =
                                    new ConcurrentDictionary<Type, TypeSymbol>(concurrencyLevel: 2, capacity: DefaultTypeMapCapacity);
        ...
        /// </summary>
        internal readonly ConcurrentDictionary<Type, TypeSymbol> TypeRefHandleToTypeMap =
                                    new ConcurrentDictionary<Type, TypeSymbol>(concurrencyLevel: 2, capacity: DefaultTypeMapCapacity);
        ...
        public override string Name
        {
            get
            {
                return typeof(object).Module.Name;
            }
        }
        ...
        public override ImmutableArray<CSharpAttributeData> GetAttributes()
        {
            ...
            {
                this.LoadCustomAttributes(typeof(object).Assembly, ref _lazyCustomAttributes);
            }
        ...
        internal void LoadCustomAttributesFilterExtensions(ICustomAttributeProvider token,
        ...
        internal ImmutableArray<CSharpAttributeData> GetCustomAttributesForToken(ICustomAttributeProvider token,
            out CustomAttributeData filteredOutAttribute1,
        ...
        internal ImmutableArray<CSharpAttributeData> GetCustomAttributesForToken(ICustomAttributeProvider token,
            out CustomAttributeData filteredOutAttribute1,
            AttributeDescription filterOut1,
            out CustomAttributeData filteredOutAttribute2,
            AttributeDescription filterOut2,
            out CustomAttributeData filteredOutAttribute3,
            AttributeDescription filterOut3,
            out CustomAttributeData filteredOutAttribute4,
            AttributeDescription filterOut4)
        {
            ...
            try
            {
                ...
                foreach (var customAttributeHandle in w.GetCustomAttributesData())
                {
        ...
        bool matchesFilter(CustomAttributeData handle, AttributeDescription filter)
        {

            return handle.Constructor.DeclaringType.FullName == filter.FullName;
        }
        /// <summary>
        ...
        internal ImmutableArray<CSharpAttributeData> GetCustomAttributesForToken(ICustomAttributeProvider token,
            out CustomAttributeData paramArrayAttribute)
        {
            return GetCustomAttributesForToken(token, out paramArrayAttribute, AttributeDescription.ParamArrayAttribute);
        }


        internal bool HasAnyCustomAttributes(ICustomAttributeProvider token)
        {
            try
            {
                foreach (var attr in token.GetCustomAttributes(false))
                {
                    return true;
                }
            }
        ...
        internal TypeSymbol TryDecodeAttributeWithTypeArgument(ICustomAttributeProvider handle, AttributeDescription attributeDescription)
        {
            //string typeName;
        ...
        internal ImmutableArray<CSharpAttributeData> GetCustomAttributesFilterExtensions(ICustomAttributeProvider token, out bool foundExtension)
        {
        ...
        internal override ICollection<string> TypeNames
        {
            get
            {
                ...
                {
                    Interlocked.CompareExchange(ref _lazyTypeNames, _module.TypeNames, null);
                }
        ...
        internal override ICollection<string> NamespaceNames
        {
            get
            {
                ...
                {
                    Interlocked.CompareExchange(ref _lazyNamespaceNames, _module.NamespaceNames, null);
                }
        ...
        {
            return new ImmutableArray<byte>(new byte[] { 0xb7, 0x7a, 0x5c, 0x56, 0x19, 0x34, 0xe0, 0x89 });
        }
