...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    internal sealed class SymbolFactory : SymbolFactory<PEModuleSymbol, TypeSymbol>
    {
        ...
        internal override TypeSymbol GetCSArrayTypeSymbol(PEModuleSymbol moduleSymbol, int rank,
         TypeSymbol elementType, ImmutableArray<ModifierInfo<TypeSymbol>> customModifiers)
        {
            return ArrayTypeSymbol.CreateCSharpArray(moduleSymbol.ContainingAssembly, CreateType(elementType, customModifiers), rank);
        }
