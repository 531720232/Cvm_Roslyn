...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
        ...
        : TypeParameterSymbol
    {
            ...
            Type handle)
        {
            ...
            {
                _name = handle.Name;
                flags = handle.GenericParameterAttributes;
        ...
        private ImmutableArray<TypeSymbolWithAnnotations> GetDeclaredConstraintTypes()
        {
            if (_lazyDeclaredConstraintTypes.IsDefault)
            {
                ...
                Type[] constraints;
                    ...
                    constraints = _handle.GetGenericParameterConstraints();// metadataReader.GetGenericParameter(_handle).GetConstraints();
                ...
                if (constraints.Length > 0)
                {
                    ...
                    foreach (var constraint in constraints)
                    {
                        ...
                        var typeSymbol = tokenDecoder.GetType1(constraint);
                        ...
                        type = NullableTypeDecoder.TransformType(type, constraint, moduleSymbol);
                ...
                if (hasUnmanagedModreqPattern && (_flags & GenericParameterAttributes.NotNullableValueTypeConstraint) == 0 ||
                    hasUnmanagedModreqPattern != (_handle).IsDefined(typeof(System.Runtime.InteropServices.UnmanagedFunctionPointerAttribute),false))
                {
        ...
        internal override bool? ReferenceTypeConstraintIsNullable
        {
            get
            {
                ...
                if(_handle.BaseType.Name=="Nullable`1")
                    {
                    return true;
                }
