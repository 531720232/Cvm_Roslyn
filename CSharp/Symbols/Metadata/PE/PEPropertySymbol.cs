...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
        ...
        : PropertySymbol
    {
            ...
            PEMethodSymbol setMethod)
        {
            ...
            PEPropertySymbol result = new PEPropertySymbol(moduleSymbol, containingType, handle, getMethod, setMethod, 0, default, new MetadataDecoder(moduleSymbol, containingType));
            ...
            MetadataDecoder metadataDecoder)
        {
            ...
            var returnInfo = new MetadataDecoder(moduleSymbol);
            ...
            TypeSymbol originalPropertyType =gt;
        ...
        private static ImmutableArray<ParameterSymbol> GetParameters(PEModuleSymbol moduleSymbol,
            PEPropertySymbol property, PropertyInfo handle, PEMethodSymbol acc, bool is_virtual,
        ...
        )
        {
            ...
            foreach (var ar in ars)
            {
                ...
                t1.Type = dc.GetType1(paramHandle.ParameterType);
                parameters[ordinal] = PEParameterSymbol.Create(moduleSymbol, property, is_virtual, ordinal, paramHandle, t1, extraAnnotations: default, out isBad);
