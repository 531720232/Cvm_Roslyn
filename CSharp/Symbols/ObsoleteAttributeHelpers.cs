...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class ObsoleteAttributeHelpers
    {
        ...
        /// </summary>
        internal static void InitializeObsoleteDataFromMetadata(ref ObsoleteAttributeData data, System.Reflection.ICustomAttributeProvider token, PEModuleSymbol containingModule, bool ignoreByRefLikeMarker)
        {
        ...
        /// done for Metadata symbol easily whereas trying to do this for source symbols could result in cycles.
        /// </summary>
        internal static ObsoleteAttributeData GetObsoleteDataFromMetadata(System.Reflection.ICustomAttributeProvider token, PEModuleSymbol containingModule, bool ignoreByRefLikeMarker)
        {
            ObsoleteAttributeData obsoleteAttributeData=null;
         
            foreach(System.ObsoleteAttribute v in token.GetCustomAttributes(typeof(System.ObsoleteAttribute),false))
            {
                obsoleteAttributeData = new ObsoleteAttributeData(ObsoleteAttributeKind.Obsolete, v.Message, v.IsError);
            }
