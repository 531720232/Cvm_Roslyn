...
namespace System.Reflection
{
	internal static class BlobUtilities
	{
		...
		{
			buffer.WriteUInt64(start, (ulong)(*(long*)(&value)));
		}
			...
			fixed (byte* ptr2 = &buffer[0])
			{
				...
				else
				{
					while (charPtr < ptr)
					{
						byte* intPtr4 = ptr3;
						ptr3 = intPtr4 + 1;
						char* intPtr5 = charPtr;
						charPtr = intPtr5 + 1;
						*intPtr4 = (byte)(*intPtr5);
					}
				}
			}
		}
		...
		{
			char* remainder;
			return GetUTF8ByteCount(str, charCount, 2147483647, out remainder);
		}
