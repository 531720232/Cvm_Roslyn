...
namespace System.Collections.Immutable
{
    ...
    public sealed partial class ImmutableHashSet<T> : IImmutableSet<T>, IHashKeyCollection<T>,  ICollection<T>, ISet<T>, ICollection, IStrongEnumerable<T, ImmutableHashSet<T>.Enumerator>
    {
        private static ImmutableHashSet<T> _emp;
        /// <summary>
...

        {
            get
            {
                if(_emp==null)
                {
                   _emp = new ImmutableHashSet<T>(SortedInt32KeyNode<HashBucket>.EmptyNode, EqualityComparer<T>.Default, 0);
                }
                return _emp;
            }
