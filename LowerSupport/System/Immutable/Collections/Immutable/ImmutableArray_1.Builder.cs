...
{
    public class Im_Comparer<T1> : IComparer<T1>
    {
        Comparison<T1> comparison;
        public Im_Comparer(Comparison<T1> ac)
        {
            comparison = ac;
        }
        ...
        public sealed class Builder : IList<T>
        {
            ...
            public void Sort(Comparison<T> comparison)
            {
                ...
                if (Count > 1)
                {
                    ...
                    Array.Sort(_elements, 0, _count,new Im_Comparer<T>(comparison));
                }
            }
