...
{
    public partial struct ImmutableArray<T> :IList<T>, IEquatable<ImmutableArray<T>>, IList, IImmutableArray, IStructuralComparable, IStructuralEquatable, IImmutableList<T>
    {
        /// <summary>
        ...
        public ImmutableArray<T> Sort(Comparison<T> comparison)
        {
            ...
            var self = this;
            return self.Sort(new Im_Comparer<T>(comparison));
        }
