...
namespace Microsoft.CodeAnalysis.Debugging
{
    internal struct CustomDebugInfoEncoder
    {
        ...
        public void AddUsingGroups(ICollection<int> groupSizes)
        {
        ...
        public void AddDynamicLocals(ICollection<(string LocalName, byte[] Flags, int Count, int SlotIndex)> dynamicLocals)
        {
        ...
        public void AddTupleElementNames(ICollection<(string LocalName, int SlotIndex, int ScopeStart, int ScopeEnd, ImmutableArray<string> Names)> tupleLocals)
        {
