...
{
    public readonly partial struct ChildSyntaxList : IEquatable<ChildSyntaxList>, IList<SyntaxNodeOrToken>
    {
        ...
        int ICollection<SyntaxNodeOrToken>.Count => throw new NotImplementedException();

        bool ICollection<SyntaxNodeOrToken>.IsReadOnly => throw new NotImplementedException();

        SyntaxNodeOrToken IList<SyntaxNodeOrToken>.this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        int IList<SyntaxNodeOrToken>.IndexOf(SyntaxNodeOrToken item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxNodeOrToken>.Insert(int index, SyntaxNodeOrToken item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxNodeOrToken>.RemoveAt(int index)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxNodeOrToken>.Add(SyntaxNodeOrToken item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxNodeOrToken>.Clear()
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxNodeOrToken>.Contains(SyntaxNodeOrToken item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxNodeOrToken>.CopyTo(SyntaxNodeOrToken[] array, int arrayIndex)
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxNodeOrToken>.Remove(SyntaxNodeOrToken item)
        {
            throw new NotImplementedException();
        }
