...
namespace Microsoft.CodeAnalysis
{
    public static partial class SyntaxNodeExtensions
    {
        ...
        private static IList<SyntaxNode> GetCurrentNodeFromTrueRoots(SyntaxNode trueRoot, SyntaxNode node)
        {
            var id = GetId(node);
            if (id != null)
            {
        ...
        {
            private readonly Dictionary<SyntaxAnnotation, IList<SyntaxNode>> _idToNodeMap;
            ...
            public CurrentNodes(SyntaxNode root)
            {
                ...
                _idToNodeMap = map.ToDictionary(kv => kv.Key, kv => (IList<SyntaxNode>)ImmutableArray.CreateRange(kv.Value));
            }

            public IList<SyntaxNode> GetNodes(SyntaxAnnotation id)
            {
                IList<SyntaxNode> nodes;
