...
{
    public readonly partial struct SeparatedSyntaxList<TNode> : IEquatable<SeparatedSyntaxList<TNode>>, IList<TNode> where TNode : SyntaxNode
    {
        ...
        int ICollection<TNode>.Count => throw new NotImplementedException();
