...
namespace Microsoft.CodeAnalysis
{
    ...
    public readonly partial struct SyntaxTriviaList : IEquatable<SyntaxTriviaList>, IList<SyntaxTrivia>
    {
        ...
        int ICollection<SyntaxTrivia>.Count => throw new NotImplementedException();

        bool ICollection<SyntaxTrivia>.IsReadOnly => throw new NotImplementedException();

        SyntaxTrivia IList<SyntaxTrivia>.this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        int IList<SyntaxTrivia>.IndexOf(SyntaxTrivia item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxTrivia>.Insert(int index, SyntaxTrivia item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxTrivia>.RemoveAt(int index)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxTrivia>.Add(SyntaxTrivia item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxTrivia>.Clear()
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxTrivia>.Contains(SyntaxTrivia item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxTrivia>.CopyTo(SyntaxTrivia[] array, int arrayIndex)
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxTrivia>.Remove(SyntaxTrivia item)
        {
            throw new NotImplementedException();
        }
    }
