...
namespace Microsoft.CodeAnalysis
{
    ...
    public readonly partial struct SyntaxTokenList : IEquatable<SyntaxTokenList>, IList<SyntaxToken>
    {
        ...
        int ICollection<SyntaxToken>.Count => throw new NotImplementedException();

        bool ICollection<SyntaxToken>.IsReadOnly => throw new NotImplementedException();

        SyntaxToken IList<SyntaxToken>.this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        int IList<SyntaxToken>.IndexOf(SyntaxToken item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxToken>.Insert(int index, SyntaxToken item)
        {
            throw new NotImplementedException();
        }

        void IList<SyntaxToken>.RemoveAt(int index)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxToken>.Add(SyntaxToken item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxToken>.Clear()
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxToken>.Contains(SyntaxToken item)
        {
            throw new NotImplementedException();
        }

        void ICollection<SyntaxToken>.CopyTo(SyntaxToken[] array, int arrayIndex)
        {
            throw new NotImplementedException();
        }

        bool ICollection<SyntaxToken>.Remove(SyntaxToken item)
        {
            throw new NotImplementedException();
        }
    }
