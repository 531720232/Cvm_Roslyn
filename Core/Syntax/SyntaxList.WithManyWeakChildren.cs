...
namespace Microsoft.CodeAnalysis.Syntax
{
    internal partial class SyntaxList
    {
        ...
        {
            private readonly ArrayElement<WeakReference>[] _children;
                ...
                : base(green, parent, position)
            {
                ...
                _children = new ArrayElement<WeakReference>[count];
            ...
            internal override SyntaxNode GetCachedSlot(int index)
            {
                ...
                var item = _children[index].Value;
                if(item!=null)
                {
                    value =(SyntaxNode) item.Target;
                }
