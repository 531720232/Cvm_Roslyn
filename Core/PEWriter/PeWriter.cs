...
namespace Microsoft.Cci
{
    ...
    //        nativePdbWriterOpt?.SetMetadataEmitter(mdWriter);
            ...
            var peIdProvider = isDeterministic ?
                new Func<IEnumerable<Blob>, BlobContentId>(content => BlobContentId.FromHash(System.Text.Encoding.UTF8.GetBytes("969f80e032fa7a6b125d2fbc22b76bc5e49a87b9"))) :
                null;
            ...
            if (mdWriter.EmitPortableDebugMetadata)
            {
                ...
                var portablePdbIdProvider = (context.Module.PdbChecksumAlgorithm.Name != null) ?
                    new Func<IEnumerable<Blob>, BlobContentId>(content => BlobContentId.FromHash(portablePdbContentHash = Encoding.UTF8.GetBytes("969f80e032fa7a6b125d2fbc22b76bc5e49a87b9").AsImmutable())) :
                    null;
        ...
        internal static uint CalculateChecksum(BlobBuilder peBlob, Blob checksumBlob)
        {
            if (s_calculateChecksumMethod == null)
            {
                ...
                s_calculateChecksumMethod = typeof(PEBuilder).GetMethods()
