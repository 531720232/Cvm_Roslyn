...
namespace Microsoft.Cci
{
    internal abstract partial class MetadataWriter
    {
        ...
        /// </summary>
        protected abstract IList<ITypeDefinition> GetTypeDefs();
        ...
        /// </summary>
        protected abstract IList<IEventDefinition> GetEventDefs();
        ...
        /// </summary>
        protected abstract IList<IFieldDefinition> GetFieldDefs();
        ...
        /// </summary>
        protected abstract IList<IMethodDefinition> GetMethodDefs();
        ...
        /// </summary>
        protected abstract IList<IPropertyDefinition> GetPropertyDefs();
        ...
        /// </summary>
        protected abstract IList<IParameterDefinition> GetParameterDefs();
        ...
        /// </summary>
        protected abstract IList<IGenericParameter> GetGenericParameters();
        ...
        /// </summary>
        protected abstract IList<AssemblyIdentity> GetAssemblyRefs();
        ...
        /// </summary>
        protected abstract IList<string> GetModuleRefs();
        ...
        /// </summary>
        protected abstract IList<ITypeMemberReference> GetMemberRefs();
        ...
        /// </summary>
        protected abstract IList<IGenericMethodInstanceReference> GetMethodSpecs();
        ...
        /// </summary>
        protected abstract IList<ITypeReference> GetTypeRefs();
        ...
        /// </summary>
        protected abstract IList<ITypeReference> GetTypeSpecs();
        ...
        /// </summary>
        protected abstract IList<BlobHandle> GetStandaloneSignatureBlobHandles();
       ...
       //   ..  nativePdbWriterOpt?.SetMetadataEmitter(this);
        ...
        private ImmutableArray<IGenericParameter> GetSortedGenericParameters()
        {
            ...
            {
                var c1 = CodedIndex.TypeOrMethodDef(GetDeclaringTypeOrMethodHandle(x));
            ...
            ImmutableArray<IGenericParameter> sortedGenericParameters)
        {
            foreach (IGenericParameter genericParameter in sortedGenericParameters)
            {
                ...
                var par = GetDeclaringTypeOrMethodHandle(genericParameter);
        ...
        private int[] SerializeMethodBodies(BlobBuilder ilBuilder, PdbWriter nativePdbWriterOpt, out Blob mvidStringFixup)
        {
            ...
            foreach (var vv in encoder.Builder.ToArray())

            {

                sb.AppendLine($"bs[{i}]={vv};");
                i++;
