...
namespace Microsoft.CodeAnalysis
{
    internal static class ModuleExtensions
    {
        ...
        /// </summary>
        public static bool ShouldImportNestedType(this PEModule module, Type typeDef)
        {
        ...
        /// </summary>
        public static bool ShouldImportField(this PEModule module, FieldInfo field, MetadataImportOptions importOptions)
        {
            try
            {
        ...
        /// </summary>
        public static bool ShouldImportMethod(this PEModule module, MethodBase methodDef, MetadataImportOptions importOptions)
        {
            try
            {
                var flags = (methodDef).Attributes;
