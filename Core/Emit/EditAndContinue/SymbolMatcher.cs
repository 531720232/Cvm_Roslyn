...
//        private IDictionary<K, V> MapDefinitions<K, V>(IDictionary<K, V> items)
...
//        private IDictionary<int, AddedOrChangedMethodInfo> MapAddedOrChangedMethods(IDictionary<int, AddedOrChangedMethodInfo> addedOrChangedMethods)
//        {
...
//        private IDictionary<AnonymousTypeKey, AnonymousTypeValue> MapAnonymousTypes(IDictionary<AnonymousTypeKey, AnonymousTypeValue> anonymousTypeMap)
//        {
