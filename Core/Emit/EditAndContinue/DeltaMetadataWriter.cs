...
//        private static IDictionary<K, V> AddRange<K, V>(IDictionary<K, V> previous, IDictionary<K, V> current, bool replace = false)
//        {
//            if (previous.Count == 0)
//            {
//                return current;
...
//        protected override IList<IEventDefinition> GetEventDefs()
//        {
...
//        protected override IList<IFieldDefinition> GetFieldDefs()
//        {
...
//        protected override IList<ITypeDefinition> GetTypeDefs()
//        {
...
//        protected override IList<IMethodDefinition> GetMethodDefs()
//        {
...
//        protected override IList<IPropertyDefinition> GetPropertyDefs()
//        {
...
//        protected override IList<IParameterDefinition> GetParameterDefs()
//        {
//            return _parameterDefs.GetRows();
//        }

//        protected override IList<IGenericParameter> GetGenericParameters()
//        {
...
//        protected override IList<AssemblyIdentity> GetAssemblyRefs()
//        {
...
//        protected override IList<string> GetModuleRefs()
//        {
...
//        protected override IList<ITypeMemberReference> GetMemberRefs()
//        {
...
//        protected override IList<IGenericMethodInstanceReference> GetMethodSpecs()
//        {
...
//        protected override IList<ITypeReference> GetTypeRefs()
//        {
...
//        protected override IList<ITypeReference> GetTypeSpecs()
//        {
...
//        protected override IList<BlobHandle> GetStandaloneSignatureBlobHandles()
//        {
...
//            public IDictionary<T, int> GetAdded()
//            {
//                this.Freeze();
//                return this.added;
//            }
