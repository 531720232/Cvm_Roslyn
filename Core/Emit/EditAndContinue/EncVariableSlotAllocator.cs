...
//        // locals:
//        private readonly IDictionary<EncLocalInfo, int> _previousLocalSlots;
...
//        private readonly IDictionary<EncHoistedLocalInfo, int> _hoistedLocalSlotsOpt;
//        private readonly int _awaiterCount;
//        private readonly IDictionary<Cci.ITypeReference, int> _awaiterMapOpt;

//        // closures:
//        private readonly IDictionary<int, KeyValuePair<DebugId, int>> _lambdaMapOpt; // SyntaxOffset -> (Lambda Id, Closure Ordinal)
//        private readonly IDictionary<int, DebugId> _closureMapOpt; // SyntaxOffset -> Id
...
//            IDictionary<int, KeyValuePair<DebugId, int>> lambdaMapOpt,
//            IDictionary<int, DebugId> closureMapOpt,
//            string stateMachineTypeNameOpt,
//            int hoistedLocalSlotCount,
//            IDictionary<EncHoistedLocalInfo, int> hoistedLocalSlotsOpt,
//            int awaiterCount,
//            IDictionary<Cci.ITypeReference, int> awaiterMapOpt,
