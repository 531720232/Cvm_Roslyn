...
//        {
//            public readonly IDictionary<AnonymousTypeKey, AnonymousTypeValue> AnonymousTypes;
...
//            public MetadataSymbols(IDictionary<AnonymousTypeKey, AnonymousTypeValue> anonymousTypes, object metadataDecoder, ImmutableDictionary<AssemblyIdentity, AssemblyIdentity> assemblyReferenceIdentityMap)
//            {
...
//        internal readonly IDictionary<Cci.ITypeDefinition, int> TypesAdded;
//        internal readonly IDictionary<Cci.IEventDefinition, int> EventsAdded;
//        internal readonly IDictionary<Cci.IFieldDefinition, int> FieldsAdded;
//        internal readonly IDictionary<Cci.IMethodDefinition, int> MethodsAdded;
//        internal readonly IDictionary<Cci.IPropertyDefinition, int> PropertiesAdded;
//        internal readonly IDictionary<int, int> EventMapAdded;
//        internal readonly IDictionary<int, int> PropertyMapAdded;
//        internal readonly IDictionary<MethodImplKey, int> MethodImplsAdded;
...
//        /// </summary>
//        internal readonly IDictionary<int, AddedOrChangedMethodInfo> AddedOrChangedMethods;
...
//        internal readonly IDictionary<int, int> TypeToEventMap;
//        internal readonly IDictionary<int, int> TypeToPropertyMap;
//        internal readonly IDictionary<MethodImplKey, int> MethodImpls;
//        private readonly IDictionary<AnonymousTypeKey, AnonymousTypeValue> _anonymousTypeMap;
...
//            Guid encId,
//            bool hasPortablePdb,
//            IDictionary<Cci.ITypeDefinition, int> typesAdded,
//            IDictionary<Cci.IEventDefinition, int> eventsAdded,
//            IDictionary<Cci.IFieldDefinition, int> fieldsAdded,
//            IDictionary<Cci.IMethodDefinition, int> methodsAdded,
//            IDictionary<Cci.IPropertyDefinition, int> propertiesAdded,
//            IDictionary<int, int> eventMapAdded,
//            IDictionary<int, int> propertyMapAdded,
//            IDictionary<MethodImplKey, int> methodImplsAdded,
...
//            IDictionary<AnonymousTypeKey, AnonymousTypeValue> anonymousTypeMap,
//            ImmutableDictionary<Cci.ITypeDefinition, ImmutableArray<Cci.ITypeDefinitionMember>> synthesizedMembers,
//            IDictionary<int, AddedOrChangedMethodInfo> methodsAddedOrChanged,
//            Func<MethodDefinitionHandle, EditAndContinueMethodDebugInformation> debugInformationProvider,
//            Func<MethodDefinitionHandle, StandaloneSignatureHandle> localSignatureProvider,
//            IDictionary<int, int> typeToEventMap,
//            IDictionary<int, int> typeToPropertyMap,
//            IDictionary<MethodImplKey, int> methodImpls)
//        {
...
//            DebugInformationProvider = debugInformationProvider;
//            LocalSignatureProvider = localSignatureProvider;
//            TableSizes = CalculateTableSizes( TableEntriesAdded);
...
//            IDictionary<AnonymousTypeKey, AnonymousTypeValue> anonymousTypeMap,
//            ImmutableDictionary<Cci.ITypeDefinition, ImmutableArray<Cci.ITypeDefinitionMember>> synthesizedMembers,
//            IDictionary<int, AddedOrChangedMethodInfo> addedOrChangedMethods,
//            Func<MethodDefinitionHandle, EditAndContinueMethodDebugInformation> debugInformationProvider,
//            Func<MethodDefinitionHandle, StandaloneSignatureHandle> localSignatureProvider)
//        {
...
//        internal IDictionary<AnonymousTypeKey, AnonymousTypeValue> AnonymousTypeMap
//        {
//            get
//            {
//                if (Ordinal > 0)
...
//        private static ImmutableArray<int> CalculateTableSizes( ImmutableArray<int> delta)
//        {
...
//        private static Dictionary<int, int> CalculateTypePropertyMap()
//        {
...
//        private static Dictionary<int, int> CalculateTypeEventMap()
//        {
//            var result = new Dictionary<int, int>();
...
//        private static Dictionary<MethodImplKey, int> CalculateMethodImpls()
//        {
