...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Diagnostic : IEquatable<Diagnostic>, IFormattable
    {
        ...
        /// </summary>
        internal virtual IList<string> CustomTags { get { return (IList<string>)this.Descriptor.CustomTags; } }
        ...
        {
            return true;// AnalyzerManager.HasNotConfigurableTag(this.CustomTags);
        }
    }
