...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Compilation
    {
        ...
        private readonly IDictionary<string, string> _features;
        ...
        protected static IDictionary<string, string> SyntaxTreeCommonFeatures(IEnumerable<SyntaxTree> trees)
        {
        ...
        {
            return !(type == typeof(void) || type.IsByRef || type.ContainsGenericParameters);
        }
            ...
            checked
            {
                ...
                if (!noManifest)
                {
                    if (this.Options.OutputKind.IsApplication())
                    {
                        ...
                        {
                            manifestContents = typeof(Compilation).Assembly.GetManifestResourceStream("Microsoft.CodeAnalysis.Resources.default.win32manifest");
                        }
                    }
                    else
                    {
