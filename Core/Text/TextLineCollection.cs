...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    public abstract class TextLineCollection : IList<TextLine>
    {
        ...
        int ICollection<TextLine>.Count => throw new NotImplementedException();

        bool ICollection<TextLine>.IsReadOnly => throw new NotImplementedException();

        TextLine IList<TextLine>.this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
