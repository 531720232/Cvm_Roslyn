...
namespace Microsoft.CodeAnalysis.Text
{
    internal sealed class ChangedText : SourceText
    {
            ...
            : base(checksumAlgorithm: oldText.ChecksumAlgorithm)
        {
            ...
            _newText = newText;
            _info = new ChangeInfo(changeRanges, new WeakReference(oldText), (oldText as ChangedText)?._info);
        }
        ...
        private class ChangeInfo
        {
            ...
            public WeakReference WeakOldText { get; }

            public ChangeInfo Previous { get; private set; }

            public ChangeInfo(ImmutableArray<TextChangeRange> changeRanges, WeakReference weakOldText, ChangeInfo previous)
            {
            ...
            private void Clean()
            {
                ...
                {
                    SourceText tmp;
                    tmp = (SourceText)info.WeakOldText.Target;
                    if (tmp!=null)
                    {
                        lastInfo = info;
                    }
        ...
        public override IList<TextChangeRange> GetChangeRanges(SourceText oldText)
        {
            ...
            SourceText actualOldText=(SourceText)_info.WeakOldText.Target;
            if (actualOldText!=null && actualOldText == oldText)
            {
        ...
        private bool IsChangedFrom(SourceText oldText)
        {
            ...
            {
                SourceText text=(SourceText)info.WeakOldText.Target;
                if (text!=null && text == oldText)
                {
                    return true;
                }
            }
        ...
        private static IList<ImmutableArray<TextChangeRange>> GetChangesBetween(SourceText oldText, ChangedText newText)
        {
            ...
            while (change != null)
            {
                SourceText actualOldText=(SourceText)change.WeakOldText.Target;
...
tryAgain:
        ...
        protected override TextLineCollection GetLinesCore()
        {
            ...
            oldText =(SourceText) _info.WeakOldText.Target;
            if (oldText==null || !oldText.TryGetLines(out oldLineInfo))
            {
