...
namespace Roslyn.Utilities
{
    internal static partial class EnumerableExtensions
    {
        ...
        {
            var readOnlyCollection = source as ICollection<T>;
        ...
        /// <remarks>
        /// This method is necessary to avoid an ambiguity between <see cref="IsEmpty{T}(ICollection{T})"/> and <see cref="IsEmpty{T}(ICollection{T})"/>.
        /// </remarks>
        ...
        {
            return source.OrderBy(new Im_Comparer<T>(compare));
        }
        ...
        {
            return source.ThenBy(new Im_Comparer<T>(compare));
        }
        ...
        private static class Comparisons<T> where T : IComparable<T>
        {
            ...
            public static readonly IComparer<T> Comparer =new Im_Comparer<T>(CompareTo);
        }
        ...
        {
            return new Im_Comparer<T>(comparison);
        }
    }
