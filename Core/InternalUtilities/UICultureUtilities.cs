...
//            try
//            {
//                var type = Type.GetType(cultureInfoTypeNameGlobalization) ?? typeof(object).Assembly.GetType(cultureInfoTypeName);
//                if ((object)type == null)
//                {
//                    setter = null;
//                    return false;
...
//                //var currentUICultureSetter = type.GetDeclaredProperty(currentUICultureName)?.SetMethod;
...
//            try
//            {
//                var type = typeof(object).Assembly.GetType(threadTypeName);
//                if ((object)type == null)
//                {
//                    setter = null;
//                    return false;
